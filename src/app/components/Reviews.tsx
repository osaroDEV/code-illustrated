...
const Reviews = () => {
  ...
  return (
    <div className="w-full h-auto bg-white py-10 lg:py-20 px-5 lg:px-25 flex flex-col gap-20">
      <div className="flex flex-col gap-15">
        <div className="w-full lg:w-[528px] h-[118px] lg:h-[97px] flex flex-col gap-[20px] lg:gap-[30px] justify-center items-center mx-auto">
          <div className="w-[101px] lg:w-[109px] flex justify-center items-center gap-[15px]">
            ...
            <h2 className="uppercase text-[10px] lg:text-[11px]">testimonials</h2>
          </div>
          <div className="flex flex-col items-center justify-center gap-[10px] px-3">
            ...
            <p className="text-[#646464] text-center text-[13px] lg:text-[15px] leading-[15.6px] font-medium">
              Join hundreds of aspiring Tech professionals who&apos;ve gained the knowledge,
              confidence, and support they needed to upskill.
            </p>
          </div>
        </div>
              ...
              <div className="w-full flex flex-col gap-[15px]">
                <div className="w-[82.7px] h-[14px] flex items-center gap-[5px]  text-white">
                  {Array.from({ length: review.stars }, (_, i) => (
                    <span
                      key={i}
                      className="w-[12px] h-[14px] bg-[#009747] flex items-center justify-center"
                    >
                      <svg
                        width="14"
                        height="14"
        ...
        <div className="w-[150px] h-10 flex items-center justify-between mx-auto">
          <span
            onClick={() => scroll('left')}
